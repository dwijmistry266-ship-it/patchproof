...
def validate_coverage_policy(requirements: dict) -> None:
    if not isinstance(requirements, dict):
        raise CoverageError("coverage policy must be an object")
    for name in ("minimum_line_rate", "minimum_branch_rate"):
